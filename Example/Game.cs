    ...
    class Game : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            */
			...
			var buildConfig = new QFontBuilderConfiguration (true);
			buildConfig.UseVertexBuffer = false;
			heading1 = new QFont("Fonts/HappySans.ttf", 72, buildConfig);
          

			controlsText = new QFont("Fonts/HappySans.ttf", 32, buildConfig);
